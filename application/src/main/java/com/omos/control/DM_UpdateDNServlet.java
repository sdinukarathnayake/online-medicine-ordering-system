...
/**
 * Servlet implementation class DM_UpdateDNServlet
 */
@WebServlet("/DM_UpdateDNServlet")
public class DM_UpdateDNServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

		String dnid = request.getParameter("noteId");	
		...
		boolean isTrue = DmUtil.updateDN(dnid, dnDate, cusName, add, ph, email, order, area, fee, partner, tracking, status);
